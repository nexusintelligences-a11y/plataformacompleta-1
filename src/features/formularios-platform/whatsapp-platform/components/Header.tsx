...
export function Header({ onRefreshAll, onRefreshLabels, isRefreshing = false }: HeaderProps = {}) {
      ...
      <div className="flex items-center gap-2">
        ...
        {onRefreshLabels && (
          <Button
            ...
            className="gap-2"
            title="Atualizar apenas as etiquetas de status"
          >
            <Tag className={`h-4 w-4 ${isRefreshing ? 'animate-spin' : ''}`} />
        ...
        {onRefreshAll && (
          <Button
            ...
            disabled={isRefreshing}
            className="gap-2"
            title="Recarregar todas as conversas"
          >
