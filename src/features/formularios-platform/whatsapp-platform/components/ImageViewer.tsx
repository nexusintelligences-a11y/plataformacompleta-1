...
export function ImageViewer({ imageUrl, imageBase64, caption, isReceived = false, messageKey }: ImageViewerProps) {
  ...
  useEffect(() => {
    const loadImage = async () => {
      // PRIORIDADE 1: Se já temos base64, criar data URL direto
      if (imageBase64) {
      ...
      // PRIORIDADE 2: Se já é uma data URL, usar diretamente
